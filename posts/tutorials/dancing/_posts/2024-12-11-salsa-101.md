...
Because the first 12 counts are identical to those of the 24-count "vuelta-setenta" (see a later article), you could call this a half-setenta (and, since *setenta* means 70, one of my follower friends joked that you could hence call this figure *trienta y cinco*, meaning 35; since various very advanced figures are already called 35 with no standard, it doesn't hurt to have just another 35).
