...
[^3]: [According to SalsaSelfie](https://salsaselfie.com/2019/06/11/cuban-salsa-sombrero-con-mambo/), this figure "requires a rueda call because there is no natural way to lead it", but this must surely be a skill issue on his behalf. Above, I have given two signals that should suffice to lead even inexperienced followers, and people like Erick Berninzon [apply them](https://youtu.be/AEhV2JFlN-c?t=193) [in practice](https://youtu.be/XN3FOksscro?t=23). Besides, many figures in casino require the follower to have *some* background knowledge of what she is supposed to do (try doing a DQN or vacilala with newbies), and also, even someone without experience will naturally start to mimic the leader's leg movements when she is being held locked in-place and somewhat surprised by what his legs are doing.
