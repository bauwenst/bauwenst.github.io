...
### Peinala
As another example, [this boy](https://www.youtube.com/watch?v=-lb6hdNkaHI), whom us starting salseros should all aspire to be like, does infinitely more complicated turns than I'm able to do (they're too fast for me to even name them), but one thing that does seem apparent is that he does a CBL with [peinala](https://www.youtube.com/shorts/V09JDEVeeb8) whenever he can. His follower gladly shows off her ability to spin fast without getting dizzy in this case, so it worked out.
