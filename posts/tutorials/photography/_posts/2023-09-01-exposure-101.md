...
description: So many tutorials teach the exposure triangle, but is it actually applied
...
One day, after many years of shooting in `P`, I realised that I was handicapping myself like a child riding its bicycle having outgrown the still-attached training wheels. I plunged myself into the deep end, and soon enough, my hands found their way to the step-by-step process for taking full control of my shots. in `M`anual mode. This process has long become muscle memory, and outperforms `P` mode every single time.
...
Many tutorials exist on the **exposure triangle**. It is the famous trio of numbers which the photographer should guard over per shot, determining how the camera "blinks": **shutter speed**, **aperture**, and **ISO**.[^1] Other tutorials already go into elaborate detail and show many examples, but often fail to teach how to apply the exposure triangle while operating the buttons and dials on the camera itself, from start to finish.
...
Exposure triangle (left) and exposure chart (right). Sources: [PNGkit](https://www.pngkit.com/png/full/4-47624_the-exposure-triangle-exposure-triangle.png) and [SLR Lounge](https://www.slrlounge.com/iso-aperture-shutter-speed-a-cheat-sheet-for-beginners/).
{:.figcaption}
...
This procedure is second-nature to me; my hands and my eyes execute it subconsciously. Usually, step 1 and 2 can be skipped after the first shot of a scene, e.g. when sightseeing or when taking portraits. It allows me to expose as best as I can, as quickly as I can.

For shooting video, manually setting the aperture is again the most noticeable stylistic choice, but many swear by [cinematic motion blur](https://www.youtube.com/watch?v=T78qvxircuk) too. If you don't care about the latter, set your camera to `A`(perture) mode and let the camera vary the shutter speed automatically. If you want that motion blur, you'll likely need to put [sunglasses](https://en.wikipedia.org/wiki/Neutral-density_filter) on your camera since you have no other options to stop light from getting in.
{:.note title="What about video?" .faded}
...
<span style="display:inline-block; white-space: nowrap; width:60%;">
    <span style="display:inline-block; vertical-align:middle; width:50%; padding: 10px;">
        <img src="/assets/img/blog/photography/DSC_7050_compressed.jpg" width="100%"/>
    </span>
    <span style="display:inline-block; vertical-align:middle; width:60%;">
...
[^1]: Opinions differ on whether it is pronounced as "aiyso" or as "aiy-es-ohw", see e.g. [Vanessa Joy](https://www.youtube.com/watch?v=QRqsjuDKs9A)'s opinion video.
